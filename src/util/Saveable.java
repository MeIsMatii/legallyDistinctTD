...
public interface Saveable {
    ...
    default Properties loadSave(String filePath) {
        Properties props = new Properties(); // Properties ist Javas built-in key=value
        try {
            // file öffnen
    ...
    /// I don't know how this works it just works this is clustered code from the docs and some thinking
    //TODO understand this mess @Colin
}